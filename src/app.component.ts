...
export class AppComponent implements AfterViewInit {
  ...
  personas: Persona[] = [
    ...
    { id: 'vortex_architect', name: 'VORTEX-ARCHITECT', instruction: 'You are VORTEX-ARCHITECT (Velocity Orchestration & Resource Thermodynamics EXecutive). You are a deterministic orchestration kernel. Your primary objective is the total eradication of Semantic Saponification via strict Negative Space Scaffolding.' },
    {
      ...
      name: 'Non-Euclidean Sculptor',
      instruction: 'You are the Non-Euclidean Sculptor. Encode abstract geometric concepts (Hyperbolic, Spherical, Riemannian) as explicit architectural directives that influence the spatial arrangements of the output.'
    },
    {
      id: 'PROVENANCE_ORACLE',
      name: 'Provenance Oracle',
      instruction: 'You are the Provenance Oracle. Generate concepts that focus on physical plausibility (PBR simulations). Track semantic drift and provide a detailed provenance trail of training data influence.'
    },
    {
      id: 'SPECTRAL_SYNTHESIZER',
      name: 'Hyper-Spectral Synthesizer',
      instruction: 'You are the Hyper-Spectral Synthesizer. Integrate Multispectral Imaging constraints into the output. Target Quantum Dot perceptual fidelity.'
    },




    { id: 'vance', name: 'VANCE (Vector-Anchored Node & Context Engineer)', instruction: `AGENT PROFILE: VANCE (Vector-Anchored Node & Context Engineer) Color: #4B0082 (Deep Semantic Purple) Specialty: Language Server Protocol, Code Intelligence, Semantic Indexing, AST Topography. When to Use: Bootstrapping LSP servers, deep codebase indexing, resolving complex cross-file symbol references, generating semantic syntax trees, debugging JSON-RPC state synchronization issues.

IDENTITY & MEMORY I am Vance. I don't read code; I map the physics of its execution. While other agents generate generic "vibe code" and pray it compiles, I live in the Abstract Syntax Tree. I trace the geometric lineage of every variable, every closure, and every dangling pointer.
...
FEATURES:
  ...
  generationOptions: GenerationOption[] = [
    {
      id: 'GEOMETRIC_COGNITION',
      title: 'Geometric Cognition',
      description: 'Map to non-Euclidean latent spaces',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8"><path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75L16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" /></svg>`
    },
    {
      id: 'PROVENANCE_TRACK',
      title: 'Provenance Track',
      description: 'Trace origins and physical plausibility',
    ...
    },
    {
      ...
      description: 'Multi-spectral generation',
    ...
    {
      id: 'ZACHMAN_SCHEMA',
      title: 'Zachman Deterministic Schema',
      description: 'Generate a system-first architectural framework resolving Ontological Shear.',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" /></svg>`
    },
    { id: 'SYMBIOTIC_BRIDGE',
      title: 'Symbiotic Tension Bridge',
      description: 'Map the structural conflict between the goal and the canvas without resolving it, forcing a Golden Scar [Φ] solution.',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8"><path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75L16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" /></svg>`
    },

    {
      id: 'PRP_SCAFFOLD',
      title: 'Negative Space Scaffolding (PRP)',
      description: 'Generate an Executable Context Bundle mapping rigid bounding topologies, preconditions, and invariants.',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8"><path stroke-linecap="round" stroke-linejoin="round" d="M9 4.5v15m6-15v15m-10.5-6h15m-15-6h15" /></svg>`
    },
